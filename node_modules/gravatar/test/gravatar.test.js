...
describe('gravatar', function() {
  ...
  var unspecifiedHash = 'd415f0e30c471dfdd9bc4f827329ef48?s=200&r=pg&d=retro'

  it('should gererate correct uri given an email', function() {
    gravatar
      .url('emerleite@gmail.com')
      .should.be.equal(baseNoProtocolURL + '93e9084aa289b7f1f5e4ab6716a56c3b')
    gravatar
      .url('emerleite@yahoo.com.br')
      .should.be.equal(baseNoProtocolURL + '6c47672b0d58bd6aae4fa70920cb3ee4')
    gravatar
      .url('93E9084AA289B7F1F5E4AB6716A56C3B@gmail.com')
      .should.be.equal(baseNoProtocolURL + '45503aaa7bc259c0ef5bba9997b77875')
  })
  ...
  it('should detect MD5 hashes and not hash them again', function() {
    gravatar
      .url('93e9084aa289b7f1f5e4ab6716a56c3b')
      .should.be.equal(baseNoProtocolURL + '93e9084aa289b7f1f5e4ab6716a56c3b')
    gravatar
      .url('93E9084AA289B7F1F5E4AB6716A56C3B')
      .should.be.equal(baseNoProtocolURL + '93e9084aa289b7f1f5e4ab6716a56c3b')
  ...
  it('should generate uri with user passed parameters', function() {
    var gravatarURL = gravatar.url('emerleite@gmail.com', {
      s: '100',
      f: 'n',
      r: 'g',
      d: 'retro'
    ...
    queryString.s.should.equal('100')
    queryString.f.should.equal('y')
    queryString.r.should.equal('g')
    queryString.d.should.equal('retro')
  })

  it('should force http protocol on gravatar uri generation', function() {
    gravatar
      .url('emerleite@gmail.com', {}, false)
      .should.be.equal(baseUnsecureURL + '93e9084aa289b7f1f5e4ab6716a56c3b')
    gravatar
      .url('emerleite@yahoo.com.br', {}, false)
      .should.be.equal(baseUnsecureURL + '6c47672b0d58bd6aae4fa70920cb3ee4')
  })

  it('should force https protocol on gravatar uri generation', function() {
    var gravatarURL = gravatar.url('emerleite@gmail.com', {}, true)
    gravatar
      .url('emerleite@gmail.com', {}, true)
      .should.equal(baseSecureURL + '93e9084aa289b7f1f5e4ab6716a56c3b')
  })
  ...
  it('should generate profile url', function() {
    gravatar
      ...
      .should.equal(profileSecureURL + '93e9084aa289b7f1f5e4ab6716a56c3b.json')
    gravatar
      .profile_url('emerleite@gmail.com', { format: 'xml' }, true)
      .should.equal(profileSecureURL + '93e9084aa289b7f1f5e4ab6716a56c3b.xml')
    gravatar
      .profile_url('emerleite@gmail.com', { format: 'qr' }, true)
      .should.equal(profileSecureURL + '93e9084aa289b7f1f5e4ab6716a56c3b.qr')
    gravatar
      .profile_url('emerleite@gmail.com')
      .should.equal(profileURL + '93e9084aa289b7f1f5e4ab6716a56c3b.json')
  })

  it('should generate unspecified profile url when email is null', function() {
    gravatar
      .profile_url(null, {}, true)
      .should.equal(profileSecureURL + unspecifiedHash + '.json')
    gravatar
  ...
  it('should force http protocol on gravatar uri generation via options', function() {
    gravatar
      .url('emerleite@gmail.com', { protocol: 'http' })
      .should.be.equal(baseUnsecureURL + '93e9084aa289b7f1f5e4ab6716a56c3b')
    gravatar
      .url('emerleite@yahoo.com.br', { protocol: 'http' })
      .should.be.equal(baseUnsecureURL + '6c47672b0d58bd6aae4fa70920cb3ee4')
  })

  it('should force https protocol on gravatar uri generation via options', function() {
    gravatar
      .url('emerleite@gmail.com', { protocol: 'https' })
      .should.equal(baseSecureURL + '93e9084aa289b7f1f5e4ab6716a56c3b')
  })
  ...
  it('should generate profile url with protocol in options', function() {
    ...
    gravatar
      ...
      .should.equal(profileURL + '93e9084aa289b7f1f5e4ab6716a56c3b.qr')
    gravatar
      .profile_url('emerleite@gmail.com')
      .should.equal(profileURL + '93e9084aa289b7f1f5e4ab6716a56c3b.json')
  })
  ...
  it('should generate profile url with cdn in options', function() {
    ...
    gravatar
      ...
      .should.equal(cdn + '/93e9084aa289b7f1f5e4ab6716a56c3b.json')
    gravatar
      .profile_url('emerleite@gmail.com', { cdn: cdn, format: 'xml' })
      .should.equal(cdn + '/93e9084aa289b7f1f5e4ab6716a56c3b.xml')
    gravatar
      .profile_url('emerleite@gmail.com', { cdn: cdn, format: 'qr' })
      .should.equal(cdn + '/93e9084aa289b7f1f5e4ab6716a56c3b.qr')
    gravatar
      .url({}, { cdn: cdn }, true)
      .should.equal(cdn + '/avatar/' + unspecifiedHash)
    gravatar
      .url(3, { cdn: cdn }, true)
      .should.equal(cdn + '/avatar/' + unspecifiedHash)
    gravatar
      .url(true, { cdn: cdn }, true)
      .should.equal(cdn + '/avatar/' + unspecifiedHash)
  })
})
